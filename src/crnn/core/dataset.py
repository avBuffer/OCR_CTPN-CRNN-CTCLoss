...
class MyDataset(Dataset):
    def __init__(self, info_filename, train=True, transform=data_tf,
...
class MyDatasetPro(Dataset):
    def __init__(self, info_filename_txtline=list(), info_filename_fullimg=list(), train=True, 
                 txtline_transform=data_tf, fullimg_transform=data_tf_fullimg, target_transform=None):
        super(Dataset, self).__init__()
